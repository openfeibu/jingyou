...
return [
    ...
    'events'  => [
        ...
        'beforeRenderTheme'  => function ($theme) {
            ...
            $theme->asset()->add('html5zoo_js', 'js/html5zoo.js');
            $theme->asset()->add('lovelygallery_js', 'js/lovelygallery.js');
            $theme->asset()->usePath()->add('common_js', 'js/common.js');
            $theme->asset()->add('fbUi_js', 'lib/fbUi/fbUi.js');
            $theme->asset()->add('share_js', 'js/share.js');
            $theme->asset()->add('qrcode_js', 'js/qrcode.min.js');
