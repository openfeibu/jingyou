            ...
            <div class="fb-main-table">
                <form class="layui-form" action="{{guard_url('link/'.$link->id)}}" method="post" method="post" lay-filter="fb-form">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="url" autocomplete="off" placeholder="请输入链接" class="layui-input" value="{{$link['url']}}">
                        </div>
                        <div class="layui-form-mid layui-word-aux">必须http://或https://开头</div>
                    </div>
                    <!--
                    <div class="layui-form-item">
