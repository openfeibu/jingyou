<div class="main">
    <div class="layui-card fb-minNav">
        <div class="layui-breadcrumb" lay-filter="breadcrumb" style="visibility: visible;">
            ...
            <a><cite>{{ trans('page.cooperator.name') }}管理</cite></a>
        </div>
    </div>
    <div class="main_full">
        <div class="layui-col-md12">
            <div class="tabel-message">
                <div class="layui-inline tabel-btn">
                    <button class="layui-btn layui-btn-warm "><a href="{{guard_url('page/cooperator/create')}}">{{ trans('app.add') }}{{ trans('page.cooperator.name') }}</a></button>
...
<script>
    var main_url = "{{guard_url('page/cooperator')}}";
    var delete_all_url = "{{guard_url('page/cooperator/destroyAll')}}";
    layui.use(['jquery','element','table'], function(){
        ...
        table.render({
            ...
            ,cols: [[
                ...
                ,{field:'image',title:'{{ trans('page.cooperator.label.image') }}', toolbar:'#imageTEM',}
