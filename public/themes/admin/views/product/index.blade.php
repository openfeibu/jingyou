<div class="main">
    <div class="layui-card fb-minNav">
        <div class="layui-breadcrumb" lay-filter="breadcrumb" style="visibility: visible;">
            ...
            <a><cite>{{ trans('product.name') }}管理</cite></a>
        </div>
    </div>
    <div class="main_full">
        <div class="layui-col-md12">
            <div class="tabel-message layui-form">
                <div class="layui-inline tabel-btn">
                    <button class="layui-btn layui-btn-warm "><a href="{{guard_url('product/product/create')}}">添加{{ trans('product.name') }}</a></button>
    ...
    layui.use(['jquery','element','table'], function(){
        ...
        table.render({
            ...
            ,cols: [[
                ...
                ,{field:'image',title:'{{ trans('product.label.image') }}', toolbar:'#imageTEM'}
                ,{field:'price',title:'{{ trans('app.price') }}',edit: 'text'}
