<div class="main">
    <div class="layui-card fb-minNav">
        <div class="layui-breadcrumb" lay-filter="breadcrumb" style="visibility: visible;">
            ...
            <a><cite>{{ trans('product.category.name') }}管理</cite></a>
        </div>
    </div>
        ...
        <div class="layui-col-md12">
            <div class="tabel-message">
                <div class="layui-inline tabel-btn">
                    <button class="layui-btn layui-btn-warm " data-type="add" data-events="add">{{ trans('app.add') }}{{ trans('product.category.name') }}</button>
    ...
    layui.use(['element','table'], function(){
        ...
        table.render({
            ...
            ,cols: [[
                ...
                ,{field:'en_name',title:'{{ trans('app.name') }}',edit: 'text'}
                ,{field:'slug',title:'{{ trans('app.slug') }}',edit: 'text'}
                ,{field:'description',title:'{{ trans('app.description') }}',edit: 'text'}
                ,{field:'en_description',title:'{{ trans('app.description') }}',edit: 'text'}
                ,{field:'image',title:'{{ trans('product.category.label.image') }}',toolbar:'#imageTEM'}
