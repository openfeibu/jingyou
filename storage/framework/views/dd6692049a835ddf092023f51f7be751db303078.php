            ...
            <div class="fb-main-table">
                <form class="layui-form" action="<?php echo e(guard_url('setting/updateCompany')); ?>" method="post" lay-filter="fb-form">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="phone" lay-verify="tel" autocomplete="off" placeholder="请输入客服手机" class="layui-input" value="<?php echo e($company['phone']); ?>">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">QQ</label>
                        <div class="layui-input-inline">
                            <input type="text" name="qq" lay-verify="tel" autocomplete="off" placeholder="请输入QQ" class="layui-input" value="<?php echo e($company['qq']); ?>">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">邮箱</label>
                        <div class="layui-input-inline">
                            <input type="text" name="email" lay-verify="tel" autocomplete="off" placeholder="请输入邮箱" class="layui-input" value="<?php echo e($company['email']); ?>">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">微信公众号名称</label>
                        <div class="layui-input-inline">
                            <input type="text" name="wechat_name" lay-verify="tel" autocomplete="off" placeholder="请输入微信公众号名称" class="layui-input" value="<?php echo e($company['wechat_name']); ?>">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">微信公众号图片</label>
                        <?php echo $company['wechat_img']->files('value')->field('wechat_img')
