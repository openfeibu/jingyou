    ...
    <div class="part1-con w1200">
        ...
        <div class="part1-con-item part1-con-item<?php echo e($i); ?>">
            <a href="">
                ...
                <div class="text"><?php echo e($page_item['title']); ?></div>
                <div class="part1-con-item-big fb-transition"><img src="<?php echo e(url('image/original/'.$page_item['other_image'])); ?>" alt=""></div>
            </a>
        </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </div>
    ...
    <div class="part4-con">
        <div class="w1200">
            <div class="part4-list fb-clearfix">
                <?php $i = 0;?>
                <?php $__currentLoopData = app('page_repository')->getAllPagesByCategorySlug('applicable_place','asc'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $page_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php $i++; ?>
    ...
    <div class="w1200 fb-clearfix">
        <div class="part7-left">
            ...
            <div class="wechat-code">
                <div class="img"><img src="<?php echo e(url('image/original/'.setting('wechat_img'))); ?>" alt=""></div>
                <div class="test">更多惊喜<br>关注微信公众平台</div>
            </div>
            <div class="drop_box">
                <b>最新展会信息</b>
                <img src="<?php echo e(url('image/original/'.page('exhibition','image'))); ?>" alt="">
                <p>
                    <?php echo page('exhibition'); ?>
        ...
        <div class="part7-right">
            ...
            <div class="part7-right-con">
                <div class="part7-imgNew">
                    <?php $i = 0;?>
                    <?php $__currentLoopData = app('page_repository')->getAllPagesByCategorySlug('information_center','asc'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $page_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php $i++; ?>
                    <div class="imgNew-item">
                        <a href="">
                            <div class="img"><img src="<?php echo e(url('image/original/'.$page_item['image'])); ?>" alt=""></div>
                            <div class="imgNew-title"><?php echo e($page_item['title']); ?> ></div>
                        </a>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
                <div class="article_list" >
                    <ul>
                        <?php $i = 0;?>
                        <?php $__currentLoopData = app('page_repository')->getPagesByCategorySlug('news','3'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $page_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php $i++; ?>
                        <li class="wpart-border-line">
                            <a href="<?php echo e($page_item['url']); ?>">
                                <div class="time">
                                    <span class="wp-new-ar-pro-time"  ><?php echo e(date('d',strtotime($page_item['updated_at']))); ?></span>
                                    <span class="date" ><?php echo e(date('Y-m',strtotime($page_item['updated_at']))); ?></span>
                                </div>
                                <div class="conts">
                                    <p class="conts-title"><?php echo e($page_item['title']); ?></p>
                                    <p class="abstract"><?php echo e($page_item['description']); ?></p>
                                </div>
                            </a>
                        </li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
