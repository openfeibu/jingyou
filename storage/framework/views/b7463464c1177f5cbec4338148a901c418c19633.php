            ...
            <div class="fb-main-table">
                <form class="layui-form" action="<?php echo e(guard_url('permission/'.$permission->id)); ?>" method="post" lay-filter="fb-form">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="title" lay-verify="slug" autocomplete="off" placeholder="请输入<?php echo e(trans('permission.label.slug')); ?>" class="layui-input" value="<?php echo e($permission->slug); ?>">
                        </div>
                    </div>
                    <div class="layui-form-item">
