<div class="main">
    <div class="layui-card fb-minNav">
        <div class="layui-breadcrumb" lay-filter="breadcrumb" style="visibility: visible;">
            ...
            <a><cite>添加<?php echo e(trans('page.cooperator.name')); ?></cite></a>
        </div>
    </div>
    <div class="main_full">
        <div class="layui-col-md12">
            <div class="fb-main-table">
                <form class="layui-form" action="<?php echo e(guard_url('page/cooperator/'.$page->id)); ?>" method="post" lay-filter="fb-form">
                    ...
                    <div class="layui-form-item">
                        <label class="layui-form-label"><?php echo e(trans('page.cooperator.label.image')); ?></label>
