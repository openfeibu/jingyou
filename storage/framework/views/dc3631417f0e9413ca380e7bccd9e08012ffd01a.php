<div class="main">
    <div class="layui-card fb-minNav">
        <div class="layui-breadcrumb" lay-filter="breadcrumb" style="visibility: visible;">
            ...
            <a><cite><?php echo e(trans('knowledge.category.name')); ?>管理</cite></a>
        </div>
    </div>
        ...
        <div class="layui-col-md12">
            <div class="tabel-message">
                <div class="layui-inline tabel-btn">
                    <button class="layui-btn layui-btn-warm " data-type="add" data-events="add"><?php echo e(trans('app.add')); ?><?php echo e(trans('knowledge.category.name')); ?></button>
...
<script>
    var main_url = "<?php echo e(guard_url('knowledge/category')); ?>";
    var delete_all_url = "<?php echo e(guard_url('knowledge/category/destroyAll')); ?>";
    ...
    layui.use(['element','table'], function(){
        ...
        table.render({
            ...
            ,cols: [[
                ...
                ,{field:'name',title:'<?php echo e(trans('app.name')); ?>',edit: 'text', minWidth:100}
                ,{field:'order',title:'<?php echo e(trans('app.order')); ?>',edit: 'text', minWidth:100}
