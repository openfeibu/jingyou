<div class="main">
    <div class="layui-card fb-minNav">
        <div class="layui-breadcrumb" lay-filter="breadcrumb" style="visibility: visible;">
            ...
            <a><cite><?php echo e(trans('case.name')); ?>管理</cite></a>
        </div>
    </div>
    <div class="main_full">
        <div class="layui-col-md12">
            <div class="tabel-message">
                <div class="layui-inline tabel-btn">
                    <button class="layui-btn layui-btn-warm "><a href="<?php echo e(guard_url('case/create')); ?>"><?php echo e(trans('app.add')); ?><?php echo e(trans('case.name')); ?></a></button>
...
<script>
    var main_url = "<?php echo e(guard_url('case')); ?>";
    var delete_all_url = "<?php echo e(guard_url('case/destroyAll')); ?>";
    layui.use(['jquery','element','table'], function(){
        ...
        table.render({
            ...
            ,cols: [[
                ...
                ,{field:'title',title:'<?php echo e(trans('app.title')); ?>',edit:"title", width:200}
                ,{field:'image',title:'<?php echo e(trans('case.label.image')); ?>', toolbar:'#imageTEM',}
